			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nom" title="${message(code: 'proposition.nom.label', default: 'Nom')}" />
				...
				<g:each in="${propositionInstanceList}" status="i" var="propositionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${propositionInstance.id}">${fieldValue(bean: propositionInstance, field: "nom")}</g:link></td>
