				...
				<li class="fieldcontain">
					<span id="login-label" class="property-label"><g:message code="user.login.label" default="Login" /></span>
						...
						<span class="property-value" aria-labelledby="login-label"><g:fieldValue bean="${userInstance}" field="login"/></span>
                                ...
                                <!--
				<g:if test="{userInstance?.motDePasse}">
				<li class="fieldcontain">
					<span id="motDePasse-label" class="property-label"><g:message code="user.motDePasse.label" default="Mot De Passe" /></span>
					
						<span class="property-value" aria-labelledby="motDePasse-label"><g:fieldValue bean="${userInstance}" field="motDePasse"/></span>
