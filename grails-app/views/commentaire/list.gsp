			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nom" title="${message(code: 'commentaire.nom.label', default: 'Nom')}" />
				...
				<g:each in="${commentaireInstanceList}" status="i" var="commentaireInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentaireInstance.id}">${fieldValue(bean: commentaireInstance, field: "nom")}</g:link></td>
