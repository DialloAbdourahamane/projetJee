	...
	<body>
		...
		<div id="show-commentaire" class="content scaffold-show" role="main">
			...
			<ol class="property-list commentaire">
				...
				<g:if test="${commentaireInstance?.nom}">
				<li class="fieldcontain">
					<span id="nom-label" class="property-label"><g:message code="commentaire.nom.label" default="Nom" /></span>
					
						<span class="property-value" aria-labelledby="nom-label"><g:fieldValue bean="${commentaireInstance}" field="nom"/></span>
