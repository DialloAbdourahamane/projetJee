	...
	<body>
		...
		<div id="show-commentaire" class="content scaffold-show" role="main">
			...
			<ol class="property-list commentaire">
				...
				<g:if test="${commentaireInstance?.com}">
				<li class="fieldcontain">
					<span id="com-label" class="property-label"><g:message code="commentaire.com.label" default="Com" /></span>
					
						<span class="property-value" aria-labelledby="com-label"><g:fieldValue bean="${commentaireInstance}" field="com"/></span>
